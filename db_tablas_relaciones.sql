...
-- agrega columna para la tabla usuario
...
UPDATE Usuario 
SET password = '$2y$10$w2xpglesITs2/uFDuLfUV.4uuhdnDwdK7h8BCgpozdhE8.PIpPKOu' -- Reemplaza con el hash generado para 'contra: admin'
